<%@ Page Title="" Language="VB" MasterPageFile="~/Bienes.master" AutoEventWireup="false" CodeFile="Descargos.aspx.vb" Inherits="Desacargos" %>
                ...
                <div class="row">
                 <div class="col-md-12">
                    ...
                    <div class ="row">
                           ...
                           <span class="widget-caption">Realizar Descargo</span>
                      </div> 
                                <div class="widget-body">
                                   
                                    <div class="flip-scroll">
                                        <asp:GridView ID="GvTrabajoAsi" CssClass="table table-striped table-bordered table-hover dataTables-example dataTable dtr-inline" Width="100%" runat="server" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" DataSourceID="SqlDataSource1" AutoGenerateColumns="False">
                                            <AlternatingRowStyle BackColor="White" />
                                            <Columns>
                                                <asp:BoundField DataField="CodDiag" HeaderText="D" SortExpression="CodDiag" />
                                                <asp:BoundField DataField="CodAsig" HeaderText="A" SortExpression="CodAsig" />
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ReplicaBienesConnectionString %>" SelectCommand="VerDescagoBienes" SelectCommandType="StoredProcedure">
                                            <SelectParameters>
