<%@ Page Title="" Language="VB" MasterPageFile="~/Soporte.master" AutoEventWireup="false" CodeFile="Realizar_Diagnosticos.aspx.vb" Inherits="Realizar_Diagnosticos" %>
     ...
     <div class="alert alert-success alert-dismissable" id="dvExito" runat="server" visible="false" style="text-align: center">
      ...
      <div class="alert alert-danger alert-dismissable" id="dvError" runat="server" visible="false" style="text-align: center">
       <button class="close" data-dismiss ="alert" ><span>&times;</span></button>
                ...
                <strong>NOTA: </strong> Error al realizar el diagnostico
                           ...
                           <span class="widget-caption">Mis Asignaciones</span>
                                ...
                                <div class="widget-body">
                                    ...
                                    <div class="flip-scroll">
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ReplicaBienesConnectionString %>" SelectCommand="VerSoliSoporte" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
